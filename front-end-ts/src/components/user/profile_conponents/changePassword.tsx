    ...
    if (np !== "" && npr !== "" ) {
      if (np === npr && this.state.error_old_pssw !== "") {
        ...
        if(this.state.error_old_pssw !== ""){
          this.setState({  error_old_pssw: "Writte current password"})
        }else{
      ...
      <div className="container">
        ...
        <div className="card text-center  mt-4">
          ...
          <div className="card-body">
            <div className="row">
              <div className="col-5">
                <label htmlFor="old_passw" className="float-left">Old Password</label>
                <input
                  id="old_passw"
                  name="old_pssw"
                  type="text"
                ...
                <small className="form-text text-muted">{error_old_pssw}</small>
              </div>
              <div className="col-5">
                <div className="row">
                  <div className="col-12">
                    ...
                    />
                    <small className="form-text text-muted">{error_new_pssw}</small>
                  </div>
                  <div className="col-12 mt-2">
                    <label
                      htmlFor="new_pssw_rpt"
                      className="float-left"
